...
## Fake TikTok screenshots

![Fake TikTok screenshots](https://opennana.com/awesome-prompt-gallery/images/468.jpeg)

- **Model:** Nano banana pro
- **Source:** [@tuzi_ai](https://x.com/tuzi_ai/status/1991523528295014822)
- **Tags:** food

**Prompt:**

```
Help me generate a screenshot of a Douyin vertical screen short video. The content is about preparing king crab in the kitchen. The chef faces the camera to show the ingredients and a complete set of kitchen utensils on the chopping board.
```
...
- **Model:** Nano banana pro
- **Source:** [@songguoxiansen](https://x.com/songguoxiansen/status/1991796627062079575)
- **Tags:** food, ui

**Prompt:**

```
A golden retriever wearing headphones sits in front of a microphone, surrounded by various dog treats and bones. It is smiling professionally at the camera. The title of the live broadcast interface reads: "Xiu Gou's mukbang: Challenge ten big bone sticks today! Brother No. 1 on the list, let's make a rocket!".
```
...
## Multi-picture style reference

![Multi-picture style reference](https://opennana.com/awesome-prompt-gallery/images/664.jpeg)

- **Model:** Nano banana pro
- **Source:** [@op7418](https://x.com/op7418/status/1995337868181717248)
- **Tags:** food

**Prompt:**

```
Please help me draw a diagram of the Mediterranean diet using the style of these three pictures.
```
...
## Make a map of China consisting of provinces and cities with delicacies
...
- **Model:** Nano banana pro
- **Source:** [@songguoxiansen](https://x.com/songguoxiansen/status/1995863480570970582)
- **Tags:** food

**Prompt:**

```
Make a map of China that includes Taiwan, with each province and city represented by the food that province or city is most famous for (provinces and cities should look like they are made of food, not pictures of food). Check carefully to make sure each province and city is correct.
```
